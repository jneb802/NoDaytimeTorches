...
namespace No_Daytime_Torches
{
    ...
    public class No_Daytime_TorchesPlugin : BaseUnityPlugin
    {
        internal const string ModName = "No_Daytime_Torches";
        ...
        public static readonly ManualLogSource No_Daytime_TorchesLogger =
        ...
        public void Awake()
        {
            ...
            ironFangAxe.Trade.RequiredGlobalKey =
                "defeated_bonemass"; // You can set a global key that is required to buy this item
        ...
        private void ReadConfigValues(object sender, FileSystemEventArgs e)
        {
            ...
            try
            {
                No_Daytime_TorchesLogger.LogDebug("ReadConfigValues called");
                Config.Reload();
            }
            catch
            {
                No_Daytime_TorchesLogger.LogError($"There was an issue loading your {ConfigFileName}");
                No_Daytime_TorchesLogger.LogError("Please check your config entries for spelling and format!");
            }
        }
